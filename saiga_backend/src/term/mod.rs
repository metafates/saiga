...
use saiga_vte::ansi::handler::{
    self, Attribute, CharsetIndex, Color, CursorShape, CursorStyle, Handler, Hyperlink, KeyboardModes,
...
pub mod test {
    ...
    ///
    /// ```rust
    /// use saiga_backend::term::test::mock_term;
    ///
...
mod tests {
    ...
    use saiga_vte::ansi::handler::{self as ansi, CharsetIndex, Handler, Charset};
    ...
    fn input_line_drawing_character() {
        ...
        term.configure_charset(CharsetIndex::G0, Charset::SpecialCharacterAndLineDrawing);
        term.input('a');
